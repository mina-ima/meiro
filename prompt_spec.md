...
* 探索フェーズ中のプレイヤービューは黒背景に**ASCIIスタイルのワイヤーフレーム透視図**を描き、赤い廊下縁ライン・オレンジの中心ガイド・シアンの点線グリッド・小さな長方形の開口部で進行方向と壁面を明確に示す。
...
* 探索中ビューも黒背景＋ワイヤーフレーム線（赤エッジ/シアン格子/中心ガイド）で幾何学的に表示し、Canvasレイヤーだけで通路立体感を再現する。
