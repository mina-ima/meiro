...
- 更新メモ(2025-10-XX): スタートの床・側壁を画面最下部まで表示しつつ奥で暗転を強め、分岐の側壁/枝道を床に接地させ、ゴール直前に分岐がある場合でも角と枝道を描きながら奥壁全面のポータルを維持するようプレビュー/テストを調整
- 更新メモ(2025-10-XX): 正面壁の煉瓦線を水平/垂直に統一し、分岐/ゴールで枝道角の壁を床エッジで止めるジオメトリ最終調整とテスト反映
